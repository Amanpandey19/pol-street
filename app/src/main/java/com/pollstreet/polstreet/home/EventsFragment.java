...
public class EventsFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        electionsItemArrayList.add(new ElectionsItem(requireActivity().getDrawable(R.drawable.events_item1),"Survey"));
        electionsItemArrayList.add(new ElectionsItem(requireActivity().getDrawable(R.drawable.events_item2),"International"));
        electionsItemArrayList.add(new ElectionsItem(requireActivity().getDrawable(R.drawable.events_item3),"Party Affairs"));
        electionsItemArrayList.add(new ElectionsItem(requireActivity().getDrawable(R.drawable.events_item4),"Political Affairs"));
        electionsItemArrayList.add(new ElectionsItem(requireActivity().getDrawable(R.drawable.events_item1),"Survey"));
        electionsItemArrayList.add(new ElectionsItem(requireActivity().getDrawable(R.drawable.events_item2),"International"));
        electionsItemArrayList.add(new ElectionsItem(requireActivity().getDrawable(R.drawable.events_item3),"Party Affairs"));
        electionsItemArrayList.add(new ElectionsItem(requireActivity().getDrawable(R.drawable.events_item4),"Political Affairs"));
        ...
        eventsRVAdapter = new EventsRVAdapter(requireContext(),electionsItemArrayList);
